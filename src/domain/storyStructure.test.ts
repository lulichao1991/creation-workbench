...
const baseState = (): ProjectState => ({
  projects: [], contentUnits: [], scripts: [], scenes: [], shots: [], assets: [], assetMedia: [], assetRequirements: [], assetRequirementSources: [], assetMediaRequirements: [], shotAssets: [], keyframes: [], generationTasks: [], generationTaskShots: [], promptCompilations: [], relations: [], storyElements: [], storyElementOccurrences: [], graphLayouts: [], projectMemories: [], memorySources: [], changeSets: [], changes: [], snapshots: [],
});
